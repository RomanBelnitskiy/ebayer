 ...
 */
@Schema(description = "The type that defines the fields for the distance between the item location and the buyer's location. ")
...
public class TargetLocation {
  ...
  **/
  @Schema(description = "This value shows the unit of measurement used to measure the distance between the location of the item and the buyer's location. This value is typically <code> mi</code> or <code> km</code>.")
   ...
   * @return value
  **/
  @Schema(description = "This value indicates the distance (measured in the measurement unit in the <b> unitOfMeasure</b>  field) between the item location and the buyer's location.")
